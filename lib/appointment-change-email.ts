...
export async function scheduleAppointmentChangeEmail(args: {
  ...
  const text = [
    ...
    `View order: ${portalUrl}`, "Photo prep checklist: https://www.gsvisions.co/appointment-checklist", "",
