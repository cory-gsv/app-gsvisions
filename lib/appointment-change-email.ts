...
export async function scheduleAppointmentChangeEmail(args: {
  ...
  const text = [
    ...
    "Print prep checklist: https://www.gsvisions.co/golden-state-visions-photo-prep-checklist.pdf", "",
